    ...
    for stride in stride_values:
        for compression in compression_values:
            ...
            with PdfPages(pdf_path_combined) as pdf_combined:
                fig_combined, axs_combined = plt.subplots(2, 5, figsize=(30, 8), sharey=True)  # 2 rows, 5 columns
                plt.subplots_adjust(top=0.91, hspace=0.5)  # Adjust top value and horizontal space
